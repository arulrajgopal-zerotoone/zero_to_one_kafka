...
public class ConsumerWithAutoCommitOffset{
    public static void main(String[] args) {
        ...
        // Setting up propertiessrc/pack1/ConsumerwithCooperativeRebal.java
        ...
        try {
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record: records) {
                    ...
                    Long committedOffset = consumer.position(topicPart);
